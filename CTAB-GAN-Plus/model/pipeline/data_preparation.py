...
class DataPrep(object):
    ...
    def __init__(
        ...
        problem = list(EncodedInfo.type.keys())[0]
        target_col = list(EncodedInfo.type.values())[0]
        if problem:
