...
#%%
"""
Data Source: https://archive.ics.uci.edu/dataset/110/yeast
"""
#%%
class CustomDataset(Dataset): 
    def __init__(
        ...
        self.config = config
        self.train = train
        base = pd.read_csv('./data/yeast.data', delimiter="  ", index_col=False, header=None)
        ...
        base = base.drop(columns=["Sequence Name"])
        
        base = base.dropna() # remove 5 rows
        ...
        self.ClfTarget = "localization_site"
